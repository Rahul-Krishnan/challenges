...
puts "1. Each username followed by its description:"
twitter_data.each do |user_data|
  user_data.each do |username, details|
...
puts "\n2. Each username and total number of followers:"
twitter_data.each do |user_data|
  user_data.each do |username, details|
    print "#{username}:".ljust(20)
    puts "#{details['number of followers']}".rjust(5)
  end
end
...
twitter_data.each do |user_data|
  user_data.each do |username, details|
    print "#{username}:".ljust(20)
    puts "#{details['latest tweet'].length}".rjust(5)
  end
end
...
twitter_data.each do |user_data|
  user_data.each do |username, details|
    print "#{username}:".ljust(20)
    character_count = 0
    details['last twenty tweets'].each do |tweet|
      character_count += tweet.length
    end

    puts "#{character_count}".rjust(5)
  end
end
...
twitter_data.each do |user_data|
  user_data.each do |username, details|
    follower_count[username] = details['number of followers']
  end
end
puts follower_count.key(follower_count.values.max)

puts "\nUser with most friends:"
friend_count = {}
twitter_data.each do |user_data|
  user_data.each do |username, details|
    friend_count[username] = details['number of friends']
  end
end
puts friend_count.key(friend_count.values.max)

puts "\nUser with most tweets:"
tweet_count = {}
twitter_data.each do |user_data|
  user_data.each do |username, details|
    tweet_count[username] = details['number of tweets']
  end
end
puts tweet_count.key(tweet_count.values.max)

puts "\nUsers with a description:"
twitter_data.each do |user_data|
  user_data.each do |username, details|
    puts username if !details['description'].nil?
  end
end

puts "\nUsers with a location:"
twitter_data.each do |user_data|
  user_data.each do |username, details|
    puts username if !details['location'].nil?
  end
end
